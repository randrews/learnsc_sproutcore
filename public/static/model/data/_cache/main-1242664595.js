...
function main() {
  ...
  Model.allRecords = SC.Store.records({type:'Data'}); // Model.Data.collection();
  Model.dataController.set('content',Model.allRecords);
  // Model.dataController.set('content', Model.Data.allRecords);
} ;
