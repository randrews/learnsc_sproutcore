...
/** @scope SC.ListItemView.prototype */ {
   ...
   */
   renderIconHtml: function(icon){
     ...
     if (icon && SC.ImageView.valueIsUrl(icon)) {
       ...
       className = icon; url = '/static/sproutcore/data/_src/english.lproj/blank.gif' ;
     }
     html.push('<img class="sc-icon ');
     html.push(className || '');
     html.push('" src="');
     html.push(url || '/static/sproutcore/data/_src/english.lproj/blank.gif') ;
     html.push('" />') ;
     html=html.join('');
     return html;
   },
  ...
  */
   ...
   renderActionHtml: function(actionClassName){
     var html = [];
     html.push('<img src="') ;
     html.push('/static/sproutcore/data/_src/english.lproj/blank.gif') ;
